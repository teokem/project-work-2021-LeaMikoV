...
if(__boost_imploc)
  message(SEND_ERROR "Target Boost::atomic already has an imported location '${__boost_imploc}', which is being overwritten with '${_BOOST_LIBDIR}/libboost_atomic.dylib'")
endif()
