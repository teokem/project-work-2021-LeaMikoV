...
## Abstract
In this project climate data for a city in Bavaria, Germany, is read in, the data is cleaned and made more readable and then analyzed using different statistical methods. This city has been chosen since I grew up there most of my childhood.  
Since my research does not include working with data sets, this project has been used to learn more about data science, i.e. working with data sets, presenting and analyzing them. Moreover, some literature search was done on how to present climate data and apply some statistical methods on it.  
